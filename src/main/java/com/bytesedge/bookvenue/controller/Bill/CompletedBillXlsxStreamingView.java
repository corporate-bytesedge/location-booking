...
public class CompletedBillXlsxStreamingView implements XlsxStreamingViewIntf {
	...
	public void createWorkBookData(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		if(map != null) {
			List<EndUser> list = DbService.getInstance().getSetupService().getEndUserCompletedBookingList();
			if(list != null) {
