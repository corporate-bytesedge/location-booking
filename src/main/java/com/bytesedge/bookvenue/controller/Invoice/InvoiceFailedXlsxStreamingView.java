...
public class InvoiceFailedXlsxStreamingView implements XlsxStreamingViewIntf {
	...
	public void createWorkBookData(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		if(map != null) {
			List<EndUser> list = DbService.getInstance().getSetupService().getInvoiceFailedList();
			if(list != null) {
