...
<div id="page-content">
	<div id="listBillDiv" class="example-box-wrapper">
		<h3>
			<spring:message code="billList-form.futurebill-label" />
    	...
    	<div id="billButtonDiv" style="margin-bottom:60px;">
			<div style="float:left;">
				<%-- <button id="billViewBt" name="billViewBt" class="btn btn-purple" onClick="javascript:viewObject('billListTable', 'billListTableHeaderCheckbox', 'Bill', '/app/bill/view/future/form?reqPage=${data.paginatedResponse.reqPage}&pageSize=${data.paginatedResponse.pageSize}&id=', 'page-content-holder');">
					<i class="glyph-icon icon-file"></i>&nbsp;<spring:message code="billList-form.view-button"/>
					</button> --%>
				<button id="billExportBt" name="billExportBt" class="btn btn-primary" onClick="window.location='/app/comingBill/list/export'">
					<i class="glyph-icon icon-arrow-down"></i>&nbsp;<spring:message code="billList-form.export-button"/>
				</button>
			</div>
			<div style="float:right">
				<button id="billRefreshBt" name="billRefreshBt" class="btn btn-azure" onClick="javascript:loadContent('/app/bill/list/future','page-content-holder');">
