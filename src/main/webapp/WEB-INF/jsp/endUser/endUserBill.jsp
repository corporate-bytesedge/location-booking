...
<div class="jumbotron jumbotron-fluid" style="text-align: center;">
  <div class="container">
    ...
    <p class="lead"> Your venue booking process completed Succesfully.</p>
    <button type="button" class="btn btn-primary" onClick="window.location.href = 'https://sr.thfcalendar.com';" title="Home">Home</button>
		...
		<div class="main-div">
			...
			<div class="row invoice-section">
				<div class="col-md-7 col-sm-7">
					...
					<div class="col-md-9 col-sm-9">
						<p>: ${endUserForm.applicationId}</p>
						<p>: ${endUserForm.createdTime}</p>
						<p>: ${endUserForm.bookingDate}</p>
					</div>
				</div>
			...
			<div class="row details-section">
				...
				<div class="col-md-10 col-sm-10">
					<p>: ${endUserForm.name}</p>
					<p>: ${endUserForm.mobileNumber}</p>
					<p>: ${endUserForm.idProof}</p>
					<p>: ${endUserForm.email}</p>
					<!-- <p>: Referred By</p> -->
				</div>
			</div>
			<table class="table table-bordered details-border">
				...
				<tr>
					<td>1</td>
					<td>${endUserForm.propertyName}</td>
					<td>${endUserForm.purposeName}</td>
					<td>${endUserForm.price}</td>
					<td>${endUserForm.cgst}</td>
					<td>${endUserForm.sgst}</td>
					<td>${endUserForm.total}</td>
				</tr>
			</table>
			<div class="row table-section">
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="col-md-7 col-sm-7">
						<p>: ${endUserForm.price}</p>
						<p>: ${endUserForm.cgst}</p>
						<p>: ${endUserForm.sgst}</p>
						<p>: ${endUserForm.serviceTax}</p>
						<p>: ${endUserForm.total}</p>
					</div>
				</div>
			</div>
