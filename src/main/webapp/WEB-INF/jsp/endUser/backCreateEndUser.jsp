...
<div class="divider"></div>
	<form:form id="createEndUserForm" onsubmit="return checkForm(this);" class="form-horizontal form-marr"
		...
		<div id="createEnduserVenueDateDiv" class="form-group">
			<label for="" class="col-sm-2 control-label"> <spring:message
					code="createAddBooking-form.date-label" /> <span class="required">*</span>
			</label>
		...
		<div id="createEndUserPurposeIdDiv" class="form-group" onclick="venueHide()" style="display:none">
			<label for="" class="col-sm-2 control-label" > <spring:message
		...
		<%-- <div id="createEndUserCapthaDiv" class="form-group">
			...
			<br>
			<div id="createEndUserCapthaDiv" class="col-sm-2">
...
function changeVenue() {
	...
	$.ajax({
		...
		success : function(returnedData) {
			...
			$("#venueId").val(venueId);
			if (venueId == '1') {
				$('#createEndUserPurposeIdDiv').show();
			} else  {
				$('#createEndUserPurposeIdDiv').hide();
			}
