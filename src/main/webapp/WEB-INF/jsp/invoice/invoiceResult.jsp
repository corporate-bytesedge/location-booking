...
#toPrint{
  ...
  <div class="container">
    	  <button type="button" class="btn btn-primary" onClick="javascript:getUrl('/app/invoice/find/form?reqPage=${reqPage}&pageSize=${pageSize}','page-content-holder');"  title="Back">Back</button>
		...
		<div class="main-div">
			...
			<div class="row invoice-section">
				<div class="col-md-7 col-sm-7">
					...
					<div class="col-md-9 col-sm-9">
						<p>: ${invoiceForm.applicationId}</p>
						<p>: ${invoiceForm.createdTime}</p>
						<p>: ${invoiceForm.bookingDate}</p>
					</div>
				</div>
			...
			<div class="row details-section">
				...
				<div class="col-md-10 col-sm-10">
					<p>: ${invoiceForm.name}</p>
					<p>: ${invoiceForm.mobileNumber}</p>
					<p>: ${invoiceForm.idProof}</p>
					<p>: ${invoiceForm.email}</p>
					<p>: ${invoiceForm.referredBy}</p>
				</div>
			</div>
			<table class="table table-bordered details-border">
				...
				<tr>
					<td>1</td>
					<td>${invoiceForm.propertyName}</td>
					<td>${invoiceForm.purposeName}</td>
					<td>${invoiceForm.price}</td>
					<td>${invoiceForm.cgst}</td>
					<td>${invoiceForm.sgst}</td>
					<td>${invoiceForm.total}</td>
				</tr>
			</table>
			<div class="row table-section">
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="col-md-7 col-sm-7">
						<p>: ${invoiceForm.price}</p>
						<p>: ${invoiceForm.cgst}</p>
						<p>: ${invoiceForm.sgst}</p>
						<p>: ${invoiceForm.serviceTax}</p>
