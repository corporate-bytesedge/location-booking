...
<div id="page-content">
	<div id="listInvoiceDiv" class="example-box-wrapper">
		<h3>
			<spring:message code="invoiceList-form.pendinginvoice-label" />
    	...
    	<div id="invoiceButtonDiv" style="margin-bottom:60px;">
			<div style="float:left;">
				<button id="invoiceViewBt" name="invoiceViewBt" class="btn btn-purple" onClick="javascript:viewObject('invoiceListTable', 'invoiceListTableHeaderCheckbox', 'Invoice', '/app/invoice/view/pending/form?reqPage=${data.paginatedResponse.reqPage}&pageSize=${data.paginatedResponse.pageSize}&id=', 'page-content-holder');">
					<i class="glyph-icon icon-file"></i>&nbsp;<spring:message code="invoiceList-form.view-button"/>
					</button>
				<button id="invoiceExportBt" name="invoiceExportBt" class="btn btn-primary" onClick="window.location='/app/invoice/pending/list/export'">
					<i class="glyph-icon icon-arrow-down"></i>&nbsp;<spring:message code="invoiceList-form.export-button"/>
				</button>
			</div>
			<div style="float:right">
				<button id="invoiceRefreshBt" name="invoiceRefreshBt" class="btn btn-azure" onClick="javascript:loadContent('/app/transactionStatus/invoice/pending','page-content-holder');">
