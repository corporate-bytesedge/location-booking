 ...
 * 
 * 
 *          Note 2: This is a modification of the code in the URL because we
 *          don't want to use a tag lib. Therefore - this implementation creates a
...
public class ConversationalSessionAttributeStore implements SessionAttributeStore, InitializingBean, Serializable {
