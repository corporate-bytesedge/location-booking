		...
		<div id="viewBillDiv" class="example-box-wrapper">
			...
			<div style="float: right">
				<button id="billViewBackBt" name="billViewBackBt" type="button"
					class="btn btn-info"
					onClick="javascript:getUrl('/app/report/bill/today?reqPage=${reqPage}&pageSize=${pageSize}','page-content-holder');">
			...
			<form:form id="viewBillForm" name="viewBillForm"
				...
				action="javascript:submitForm('/app/bill/view', 'viewBillForm', 'page-content-holder')"
