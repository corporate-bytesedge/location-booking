...
#createEndUserOtpBackBt {
	...
	<div id="createForgotPasswdDiv" class="example-box-wrapper wrapper-div">
		<div class="text-centrCls">
			<h3>
				<spring:message code="createForgotPasswd-form.createForgotPasswd-label" />
			</h3>
		</div>
	...
	<form:form id="createForgotPasswd" class="form-horizontal"
		data-parsley-validate=""
		action="javascript:submitForm('/apu/forgotPasswd/create', 'createForgotPasswd', 'page-content-holder')"
		...
		<div id="createForgotPasswdEmailDiv" class="form-group">
			<label for="" class="col-sm-2 control-label"> <spring:message
					code="createForgotPasswd-form.email-label" /> <span class="required">*</span>
			</label>
			<div id="createForgotPasswdEmailDiv" class="col-sm-8">
		...
		<div id="createForgotPasswdMobileNumberDiv" class="form-group">
			<label for="" class="col-sm-2 control-label"> <spring:message
					code="createForgotPasswd-form.mobileNumber-label" /> <span
				class="required">*</span>
			</label>
			<div id="createForgotPasswdMobileNumberDiv" class="col-sm-8">
		...
		<div id="createForgotPasswdCapthaDiv" class="form-group">
			...
			<br>
			<div id="createForgotPasswdCapthaDiv" class="col-sm-2">
		...
		<div id="createForgotPasswdButtonsDiv" class="form-group">
			<div class="col-sm-offset-2 col-sm-8">
				<div class="example-box-wrapper">
					<button id="ForgotPasswdCreateSubmitBt"
						name="ForgotPasswdCreateSubmitBt" type="submit"
						class="btn btn-success">
						<i class="glyph-icon icon-plus-square"></i>&nbsp;
						<spring:message code="createForgotPasswd-form.submit-button" />
					</button>
